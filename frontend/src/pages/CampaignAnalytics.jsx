                ...
                <div className="flex items-center justify-between">
                    <div>
                        <button 
                            ...
                            className="flex items-center gap-2 text-slate-500 hover:text-blue-500 transition-colors mb-4 focus:outline-none"
                        >
                            <span className="text-xl font-black">&larr;</span>
                            <span className="text-[10px] font-black uppercase tracking-widest">Back to Campaigns</span>
                        </button>
                        <h2 className="text-3xl font-black text-slate-800 dark:text-white uppercase tracking-tight">Campaign Intelligence</h2>
                        <p className="text-sm text-slate-500 dark:text-gray-400 font-bold mt-1">{campaignName}</p>
                    </div>
                </div>

                <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-slate-200 dark:border-gray-800 p-6 md:p-8">
                    {loading ? (
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="mt-8">
                                ...
                                {/* Action Buttons */}
                                <div className="flex gap-4 p-2 mt-8">
