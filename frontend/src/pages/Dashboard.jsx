...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen w-full font-poppins relative">
      ...
      {/* Clean pure white background - Elite/Premium Feel */}
      <div className="fixed inset-0 w-full h-full z-0 bg-white" aria-hidden="true"></div>
      {/* Scrollable content with high density (zoomed out) layout */}
      <div className="relative min-h-screen w-full flex flex-col px-4 md:px-8 lg:px-12 xl:px-16 z-10 bg-transparent scale-95 origin-top">
        ...
        {activeTab === 'analyzer' ? (
          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center pt-12 pb-8">
              ...
              >
                <span
                  className="text-6xl md:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 drop-shadow-lg font-[Pacifico,cursive]"
              ...
              <motion.div
                ...
                className="text-2xl md:text-3xl font-bold text-gray-600 font-poppins"
              >
                AI Command Center
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="max-w-[1920px] mx-auto w-full mb-12"
            >
              {/* Neural Activity Feed - Simplified, Compact & Pure White */}
              <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-8 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-gray-900 font-extrabold tracking-tight text-lg uppercase">Live Neural Feed</h3>
                  </div>
                  <span className="text-[10px] text-gray-400 uppercase font-bold tracking-wider bg-gray-50 px-3 py-1 rounded-full border border-gray-100">Real-time</span>
                </div>
                  ...
                  <AnimatePresence mode="popLayout">
                    {activities.map((activity, idx) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all"
                      >
                        <div className={`p-2.5 rounded-xl ${activity.type === 'search' ? 'bg-blue-100 text-blue-600' :
                          activity.type === 'analysis' ? 'bg-purple-100 text-purple-600' :
                            activity.type === 'writing' ? 'bg-pink-100 text-pink-600' :
                              'bg-indigo-100 text-indigo-600'
                          }`}>
                          {activity.type === 'search' && <RocketLaunchIcon className="w-5 h-5" />}
                          {activity.type === 'analysis' && <SparklesIcon className="w-5 h-5" />}
                          {activity.type === 'writing' && <ChatBubbleLeftRightIcon className="w-5 h-5" />}
                          {activity.type === 'system' && <ShieldCheckIcon className="w-5 h-5" />}
                        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                ...
                <motion.div
                  ...
                  className="relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl p-8 shadow-xl cursor-pointer"
                ...
                >
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="px-3 py-1.5 bg-green-400 rounded-full">
                        <span className="text-xs font-black text-green-900">ACTIVE</span>
                      </div>
                    </div>
                    <h3 className="text-2xl font-black text-white mb-2">Lead Engine</h3>
                    <p className="text-sm text-blue-100 mb-6">Neural scraping technology</p>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-blue-100">Today's Finds</span>
                        <span className="text-xl font-black text-white">2,489</span>
                      </div>
                      <div className="flex justify-between items-center">
                ...
                <motion.div
                  whileHover={{ scale: 1.03, y: -6 }}
                  className="relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-700 rounded-3xl p-8 shadow-xl"
                >
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm">
                      ...
                      <div className="px-3 py-1.5 bg-amber-400 rounded-full">
                        <span className="text-xs font-black text-amber-900">COMING SOON</span>
                      </div>
                    </div>
                    <h3 className="text-2xl font-black text-white mb-2">Sentiment Scorer</h3>
                    <p className="text-sm text-purple-100 mb-6">AI-powered mood analysis</p>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-purple-100">Hot Leads</span>
                        <span className="text-xl font-black text-white">--</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-purple-100">Avg. Temperature</span>
                        <span className="text-xl font-black text-white">--</span>
                      </div>
                    </div>
                  </div>
                ...
                <motion.div
                  ...
                  className="relative overflow-hidden bg-gradient-to-br from-pink-500 to-pink-700 rounded-3xl p-8 shadow-xl cursor-pointer"
                >
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm">
                      ...
                      <div className="px-3 py-1.5 bg-pink-100 rounded-full animate-pulse">
                        <span className="text-xs font-black text-pink-700">REVIEW (3)</span>
                      </div>
                    </div>
                    <h3 className="text-2xl font-black text-white mb-2">Icebreaker AI</h3>
                    <p className="text-sm text-pink-100 mb-6">Hyper-personalized openers</p>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-pink-100">Generated</span>
                        <span className="text-xl font-black text-white">1,204</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-pink-100">Success Rate</span>
                ...
                <motion.div
                  ...
                  className="relative overflow-hidden bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-3xl p-8 shadow-xl cursor-pointer"
                >
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm">
                      ...
                      <div className="px-3 py-1.5 bg-green-400 rounded-full flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-full bg-green-900 animate-pulse"></span>
                        <span className="text-xs font-black text-green-900">ONLINE</span>
                      </div>
                    </div>
                    <h3 className="text-2xl font-black text-white mb-2">Objection Handler</h3>
                    <p className="text-sm text-indigo-100 mb-6">RAG-powered responses</p>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-indigo-100">Handled</span>
                        <span className="text-xl font-black text-white">--</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-indigo-100">Conversion</span>
                        <span className="text-xl font-black text-white">--</span>
                      </div>
                    </div>
                  </div>
