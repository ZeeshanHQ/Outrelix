...
const OTPVerificationModal = ({
  ...
  const [resendCooldown, setResendCooldown] = useState(60); // 60 seconds before first resend allowed
  ...
  // Resend cooldown timer (separate from expiry)
  useEffect(() => {
    if (resendCooldown > 0) {
  ...
  const handleOTPChange = (e) => {
    // Allow paste and typing - strip non-digits, limit to 6
        ...
        >
          ...
          <div className="mb-6">
            ...
            <input
              ...
              inputMode="numeric"
              className="w-full px-4 py-3 text-center text-2xl font-semibold border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
