        ...
        >
          ...
          <div className="flex flex-col items-center text-center px-8 py-10">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-10">
              <span className="px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-blue-600/10 text-blue-700 dark:text-blue-300 text-sm font-medium border border-blue-100 dark:border-blue-800">
                ⚡️ Smart Automation
              </span>
              <span className="px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/10 to-purple-600/10 text-purple-700 dark:text-purple-300 text-sm font-medium border border-purple-100 dark:border-purple-800">
                🎯 Personalized Outreach
              </span>
              <span className="px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/10 to-pink-600/10 text-pink-700 dark:text-pink-300 text-sm font-medium border border-pink-100 dark:border-pink-800">
                📈 Real-time Analytics
              </span>
            </div>
