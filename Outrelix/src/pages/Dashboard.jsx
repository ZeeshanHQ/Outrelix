              ...
              <div className="relative group overflow-hidden bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-[2rem] p-8 md:p-12 border border-white/10 shadow-2xl transition-all hover:border-blue-500/30">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                  ...
                  <div className="hidden lg:block w-72 h-72 relative">
                    ...
                    <div className="relative z-10 w-full h-full glass-card p-4 rounded-[2rem] border border-white/10 backdrop-blur-3xl overflow-hidden flex flex-col items-center justify-center text-center">
                      <UsersIcon className="w-16 h-16 text-blue-400 mb-4" />
                      <div className="text-sm font-bold text-gray-300 mb-1">Targeting Precision</div>
